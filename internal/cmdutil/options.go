...
// Theme returns a writer-aware Theme for richer, branded output (cards,
// banners, status icons, error boxes). It honors --no-color and the
// stdout/stderr TTY state just like Style().
func (o Options) Theme() output.Theme {
	return output.NewTheme(o.Style().Enabled())
}
